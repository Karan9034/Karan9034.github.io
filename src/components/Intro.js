        ...
        <div className="intro-content display-table">
          <div className="table-cell">
            <div className="container">
              ...
              <p className="pt-3"><a className="btn btn-primary btn js-scroll px-4" href="https://drive.google.com/file/d/1-fNdqyJZybRARQxrGRLaljTvVJqhQtg4/view?usp=sharing" role="button">View My Resume</a></p>
            </div>
          </div>
        </div>
      </div>
